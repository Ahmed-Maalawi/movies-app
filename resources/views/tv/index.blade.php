...
@section('content')
    ...
    <div class="container px-8 md:px-10 pt-16 mx-auto border-b border-gray-800 pb-8">
        <div class="popular-movies">
            <h2 class="uppercase text-orange-500 text-lg font-semibold tracking-wide">popular tv</h2>
        </div>
    ...
    <div class="container px-8 md:px-10 pt-16 mx-auto mb-12 border-b border-gray-800 pb-8">
        <div class="playing-movies-now">
            <h2 class="uppercase text-orange-500 text-lg font-semibold tracking-wide">top rated tv</h2>
        </div>
